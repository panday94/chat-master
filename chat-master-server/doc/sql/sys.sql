...
-- ----------------------------
BEGIN;
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                       `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`,
                                       `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`)
...
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                       `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`,
                                       `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`)
VALUES (1079, 'root', '2023-04-28 15:36:28', 'admin', '2023-04-28 15:36:28', '用户列表', '', '', '', 'member',
...
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                       `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`,
                                       `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`)
VALUES (1180, 'System', '2024-03-18 13:52:44', 'admin', '2024-03-18 13:53:39', '大模型信息', '', '', '', 'model',
        'gpt/model/index', '', '', 1080, 0, 2, 1, 1, 0, 0);
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                       `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`,
                                       `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`)
VALUES (1181, 'System', '2024-03-18 13:52:45', 'System', '2024-03-18 13:52:45', '大模型信息列表', '', '', '#', '#', '',
        '', 'gpt:model:list', 1180, 0, 3, 1, 1, 0, 0);
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                       `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`,
                                       `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`)
VALUES (1182, 'System', '2024-03-18 13:52:45', 'System', '2024-03-18 13:52:45', '大模型信息查询', '', '', '#', '#', '',
        '', 'gpt:model:query', 1180, 0, 3, 2, 1, 0, 0);
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                       `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`,
                                       `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`)
VALUES (1183, 'System', '2024-03-18 13:52:45', 'System', '2024-03-18 13:52:45', '大模型信息新增', '', '', '#', '#', '',
        '', 'gpt:model:save', 1180, 0, 3, 3, 1, 0, 0);
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                       `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`,
                                       `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`)
VALUES (1184, 'System', '2024-03-18 13:52:45', 'System', '2024-03-18 13:52:45', '大模型信息修改', '', '', '#', '#', '',
        '', 'gpt:model:update', 1180, 0, 3, 4, 1, 0, 0);
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                       `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`,
                                       `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`)
VALUES (1185, 'System', '2024-03-18 13:52:45', 'System', '2024-03-18 13:52:45', '大模型信息删除', '', '', '#', '#', '',
        '', 'gpt:model:remove', 1180, 0, 3, 5, 1, 0, 0);
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                       `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`,
                                       `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`)
VALUES (1186, 'System', '2024-03-18 13:52:45', 'System', '2024-03-18 13:52:45', '大模型信息审核', '', '', '#', '#', '',
        '', 'gpt:model:audit', 1180, 0, 3, 6, 1, 0, 0);
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                       `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`,
                                       `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`)
VALUES (1187, 'System', '2024-03-18 13:52:45', 'System', '2024-03-18 13:52:45', '大模型信息导出', '', '', '#', '#', '',
        '', 'gpt:model:export', 1180, 0, 3, 7, 1, 0, 0);
COMMIT;
...
INSERT INTO `sys_dict_type` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                        `type`, `status`, `deleted`)
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_dict` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `label`, `value`,
...
INSERT INTO `sys_dict` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `label`, `value`,
                                   `dict_type`, `css_class`, `list_class`, `is_default`, `sort`, `status`, `deleted`,
                                   `remark`)
VALUES (44, 'admin', '2024-01-22 09:30:24', 'admin', '2024-01-22 09:30:24', '无', '0', 'sys_sms_type', '', 'info', 0, 1, 1, 0, '');
INSERT INTO `sys_dict` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `label`, `value`,
                                   `dict_type`, `css_class`, `list_class`, `is_default`, `sort`, `status`, `deleted`,
                                   `remark`)
VALUES (45, 'admin', '2024-01-22 09:30:37', 'admin', '2024-01-22 09:30:37', '阿里云SMS', '1', 'sys_sms_type', '',
        'success', 0, 1, 1, 0, '');
INSERT INTO `sys_dict` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `label`, `value`,
                        `dict_type`, `css_class`, `list_class`, `is_default`, `sort`, `status`, `deleted`,
                        `remark`)
VALUES (46, 'admin', '2024-01-22 15:37:59', 'System', '2024-03-13 20:51:59', '腾讯云SMS', '2', 'sys_sms_type', '',
        'success', 0, 2, 1, 0, '');
INSERT INTO `sys_dict` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `label`, `value`,
                        `dict_type`, `css_class`, `list_class`, `is_default`, `sort`, `status`, `deleted`,
                        `remark`)
VALUES (47, 'admin', '2024-01-22 15:37:59', 'System', '2024-03-14 11:09:34', '文心一言', 'WENXIN', 'gpt_model_type', '',
        'success', 0, 2, 1, 0, '');
INSERT INTO `sys_dict` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `label`, `value`,
                        `dict_type`, `css_class`, `list_class`, `is_default`, `sort`, `status`, `deleted`,
                        `remark`)
VALUES (48, 'admin', '2024-01-22 15:38:17', 'System', '2024-03-14 11:09:37', '通义千问', 'QIANWEN', 'gpt_model_type',
        '', 'info', 0, 3, 1, 0, '');
INSERT INTO `sys_dict` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `label`, `value`,
                        `dict_type`, `css_class`, `list_class`, `is_default`, `sort`, `status`, `deleted`,
                        `remark`)
VALUES (49, 'admin', '2024-01-22 15:38:34', 'System', '2024-03-14 11:09:39', '讯飞星火', 'SPARK', 'gpt_model_type', '',
        'warning', 0, 4, 1, 0, '');
INSERT INTO `sys_dict` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `label`, `value`,
                        `dict_type`, `css_class`, `list_class`, `is_default`, `sort`, `status`, `deleted`,
                        `remark`)
VALUES (50, 'admin', '2024-01-22 15:39:03', 'admin', '2024-03-14 11:09:44', '智谱清言', 'ZHIPU', 'gpt_model_type', '',
        'danger', 0, 5, 1, 0, '');
COMMIT;
...
INSERT INTO `sys_base_config` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                          `data`, `deleted`)
VALUES (1, 'admin', '2024-01-22 10:38:39', 'admin', '2024-03-18 14:51:52', 'baseInfo',
        '{\"contentSecurity\":0,\"copyright\":\"© 2023 ChatMASTER 苏ICP备66668888号 江苏Master科技有限公司\",\"descrip\":\"ChatMASTER，基于AI大模型api实现的ChatGPT服务，支持ChatGPT(3.5、4.0)模型，同时也支持国内文心一言(支持Stable-Diffusion-XL作图)、通义千问、讯飞星火、智谱清言(ChatGLM)等主流模型，支出同步响应及流式响应，完美呈现打印机效果。\",\"keywords\":[\"通义千问\",\"ChatGPT\",\"文心一言\",\"智谱清言\"],\"siteTitle\":\"ChatMASTER\",\"domain\":\"https://gpt.panday94.xyz\",\"proxyType\":1,\"siteLogo\":\"\"}',
        0);
INSERT INTO `sys_base_config` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                          `data`, `deleted`)
VALUES (2, 'admin', '2024-01-22 10:39:48', 'admin', '2024-03-18 14:54:13', 'appInfo',
        '{\"h5Url\":\"https://gpt.panday94.xyz/h5\",\"isSms\":0,\"homeNotice\":\"确保合法合规使用，在运营过程中产生的一切问题后果自负，与作者无关。!\",\"isGptLimit\":1,\"isShare\":1,\"shareRewardNum\":\"20\",\"freeNum\":\"5\"}',
        0);
INSERT INTO `sys_base_config` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                          `data`, `deleted`)
VALUES (3, 'admin', '2024-01-22 10:39:53', 'System', '2024-01-22 10:39:53', 'wxInfo',
        '{\"mpLogin\":0,\"mpPay\":0,\"maAppId\":\"xx\",\"maSecret\":\"xx\",\"mpAppId\":\"xx\",\"mpSecret\":\"xx\",\"mchNo\":\"xx\",\"v3Secret\":\"xx\"}',
        0);
INSERT INTO `sys_base_config` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`,
                                          `data`, `deleted`)
VALUES (4, 'admin', '2024-01-22 10:40:04', 'admin', '2024-03-18 14:51:25', 'extraInfo',
        '{\"uploadSize\":\"100\",\"bucketName\":\"\",\"ossType\":1,\"registerTemplate\":\"\",\"endpoint\":\"\",\"smsKeySecret\":\"\",\"ossKeySecret\":\"\",\"ossKeyId\":\"\",\"smsAppId\":\"\",\"smsType\":0,\"smsRegionId\":\"\",\"smsKeyId\":\"\",\"smsSign\":\"\"}',
        0);
