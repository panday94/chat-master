...
-- ----------------------------
BEGIN;
INSERT INTO `sys_base_config` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `data`, `deleted`) VALUES (1, 'admin', '2024-01-22 10:38:39', 'root', '2024-12-09 18:56:57', 'baseInfo', '{\"contentSecurity\":0,\"copyright\":\"© 2023 ChatMASTER 熊扬软件开发工作室\",\"descrip\":\"ChatMASTER，基于AI大模型api实现的ChatGPT服务，支持ChatGPT(3.5、4.0)模型，同时也支持国内文心一言(支持Stable-Diffusion-XL作图)、通义千问、讯飞星火、智谱清言(ChatGLM)等主流模型，支出同步响应及流式响应，完美呈现打印机效果。\",\"keywords\":[\"通义千问\",\"ChatGPT\",\"文心一言\",\"智谱清言\"],\"proxyServer\":\"\",\"siteTitle\":\"ChatMASTER\",\"domain\":\"https://chatmaster.top\",\"proxyType\":2,\"siteLogo\":\"\"}', 0);
INSERT INTO `sys_base_config` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `data`, `deleted`) VALUES (2, 'admin', '2024-01-22 10:39:48', 'root', '2024-06-01 16:54:43', 'appInfo', '{\"h5Url\":\"https://chatmaster.top/h5\",\"isSms\":1,\"homeNotice\":\"确保合法合规使用，在运营过程中产生的一切问题后果自负，与作者无关。!\",\"isGptLimit\":0,\"isShare\":1,\"shareRewardNum\":\"20\",\"freeNum\":\"5\",\"isRedemption\":1}', 0);
