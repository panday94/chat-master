...
INSERT INTO `gpt_model` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `icon`, `model`, `version`, `status`, `deleted`) VALUES (5, 'System', '2023-12-27 00:38:20', 'admin', '2024-03-18 14:13:49', '智谱清言', '', 'ZHIPU', 'chatGLM_6b_SSE', 1, 0);
COMMIT;
...
INSERT INTO `gpt_openkey` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `app_id`, `app_key`, `app_secret`, `total_tokens`, `used_tokens`, `surplus_tokens`, `status`, `model`, `remark`, `deleted`) VALUES (2, 'System', '2023-09-07 09:20:48', 'System', '2024-03-18 16:00:09', '', '', '', 100000, 0, 0, 1, 'WENXIN', '', 0);
INSERT INTO `gpt_openkey` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `app_id`, `app_key`, `app_secret`, `total_tokens`, `used_tokens`, `surplus_tokens`, `status`, `model`, `remark`, `deleted`) VALUES (3, 'System', '2023-09-12 02:24:22', 'System', '2024-03-18 16:00:10', '', '', '', 100000, 0, 0, 1, 'QIANWEN', '', 0);
INSERT INTO `gpt_openkey` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `app_id`, `app_key`, `app_secret`, `total_tokens`, `used_tokens`, `surplus_tokens`, `status`, `model`, `remark`, `deleted`) VALUES (4, 'System', '2023-09-12 02:25:27', 'master', '2024-03-18 16:00:12', '', '', '', 100000, 0, 0, 1, 'SPARK', '', 0);
INSERT INTO `gpt_openkey` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `app_id`, `app_key`, `app_secret`, `total_tokens`, `used_tokens`, `surplus_tokens`, `status`, `model`, `remark`, `deleted`) VALUES (5, 'System', '2023-12-27 00:37:59', 'System', '2024-03-18 16:00:23', '', '', '', 100000, 0, 0, 1, 'ZHIPU', '', 0);
COMMIT;
...
CREATE TABLE `sys_audit_log` (
  ...
  KEY `fk_id` (`fk_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='审核日志';
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_base_config` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `data`, `deleted`) VALUES (1, 'admin', '2024-01-22 10:38:39', 'admin', '2024-03-18 14:51:52', 'baseInfo', '{\"contentSecurity\":0,\"copyright\":\"© 2023 ChatMASTER 苏ICP备66668888号 江苏Master科技有限公司\",\"descrip\":\"ChatMASTER，基于AI大模型api实现的ChatGPT服务，支持ChatGPT(3.5、4.0)模型，同时也支持国内文心一言(支持Stable-Diffusion-XL作图)、通义千问、讯飞星火、智谱清言(ChatGLM)等主流模型，支出同步响应及流式响应，完美呈现打印机效果。\",\"keywords\":[\"通义千问\",\"ChatGPT\",\"文心一言\",\"智谱清言\"],\"siteTitle\":\"ChatMASTER\",\"domain\":\"https://gpt.panday94.xyz\",\"proxyType\":1,\"siteLogo\":\"\"}', 0);
INSERT INTO `sys_base_config` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `data`, `deleted`) VALUES (2, 'admin', '2024-01-22 10:39:48', 'admin', '2024-03-18 16:01:34', 'appInfo', '{\"h5Url\":\"https://gpt.panday94.xyz/h5\",\"isSms\":0,\"homeNotice\":\"确保合法合规使用，在运营过程中产生的一切问题后果自负，与作者无关。!\",\"isGptLimit\":0,\"isShare\":1,\"shareRewardNum\":\"20\",\"freeNum\":\"5\"}', 0);
...
INSERT INTO `sys_base_config` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `data`, `deleted`) VALUES (4, 'admin', '2024-01-22 10:40:04', 'admin', '2024-03-18 14:51:25', 'extraInfo', '{\"uploadSize\":\"100\",\"bucketName\":\"\",\"ossType\":1,\"registerTemplate\":\"\",\"endpoint\":\"\",\"smsKeySecret\":\"\",\"ossKeySecret\":\"\",\"ossKeyId\":\"\",\"smsAppId\":\"\",\"smsType\":0,\"smsRegionId\":\"\",\"smsKeyId\":\"\",\"smsSign\":\"\"}', 0);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='字典数据表';
...
INSERT INTO `sys_dict` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `label`, `value`, `dict_type`, `css_class`, `list_class`, `is_default`, `sort`, `status`, `deleted`, `remark`) VALUES (40, 'admin', '2023-09-06 15:33:28', 'admin', '2023-09-06 15:33:28', 'ChatGpt', 'CHAT_GPT', 'gpt_model_type', '', 'primary', 0, 1, 1, 0, '');
...
INSERT INTO `sys_dict` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `label`, `value`, `dict_type`, `css_class`, `list_class`, `is_default`, `sort`, `status`, `deleted`, `remark`) VALUES (50, 'admin', '2024-01-22 15:39:03', 'admin', '2024-03-14 11:09:44', '智谱清言', 'ZHIPU', 'gpt_model_type', '', 'danger', 0, 5, 1, 0, '');
COMMIT;
...
CREATE TABLE `sys_group_role` (
  ...
  KEY `role_id` (`role_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户组角色';
...
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`, `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`) VALUES (4, 'System', '2022-08-04 15:31:10', 'admin', '2022-08-04 15:31:10', 'ChatMASTER', '', '', 'guide', 'https://chat.panday94.xyz', '', '', '', 0, 1, 1, 8, 1, 0, 0);
...
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`, `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`) VALUES (109, 'System', '2022-08-04 15:31:10', 'System', '2022-08-04 15:31:10', '在线用户', '', '', 'online', 'online', 'monitor/online/index', '', '', 2, 0, 2, 1, 1, 0, 0);
...
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`, `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`) VALUES (111, 'System', '2022-08-04 15:31:10', 'System', '2022-08-04 15:31:10', '数据监控', '', '', 'druid', 'druid', 'monitor/druid/index', '', '', 2, 0, 2, 3, 1, 0, 0);
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`, `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`) VALUES (112, 'System', '2022-08-04 15:31:10', 'System', '2022-08-04 15:31:10', '服务监控', '', '', 'server', 'server', 'monitor/server/index', '', '', 2, 0, 2, 4, 1, 0, 0);
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`, `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`) VALUES (113, 'System', '2022-08-04 15:31:10', 'System', '2022-08-04 15:31:10', '缓存监控', '', '', 'redis', 'cache', 'monitor/cache/index', '', '', 2, 0, 2, 5, 1, 0, 0);
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`, `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`) VALUES (114, 'System', '2022-08-04 15:31:10', 'System', '2022-08-04 15:31:10', '缓存列表', '', '', 'redis-list', 'cacheList', 'monitor/cache/list', '', '', 2, 0, 2, 6, 1, 0, 0);
...
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`, `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`) VALUES (1055, 'System', '2022-08-04 15:31:10', 'System', '2022-08-04 15:31:10', '在线列表', '', '', '#', '#', '', '', 'monitor:online:list', 109, 0, 3, 1, 1, 0, 0);
INSERT INTO `sys_resource` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `title`, `code`, `icon`, `path`, `component`, `query`, `perms`, `parent_id`, `redirect`, `type`, `sort`, `status`, `hidden`, `deleted`) VALUES (1056, 'System', '2022-08-04 15:31:10', 'System', '2022-08-12 15:12:05', '强退用户', '', '', '#', '#', '', '', 'monitor:online:forceLogout', 109, 0, 3, 4, 1, 0, 0);
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `login_time`, `username`, `password`, `uid`, `name`, `nick_name`, `tel`, `avatar`, `email`, `gender`, `status`, `admind`, `deleted`) VALUES (1, 'System', '2024-03-04 10:29:35', 'System', '2024-03-14 18:45:52', '2024-03-14 18:45:52', 'root', '$2a$10$ZJrHs1/UHizEmXbw1auMs.DR9pal5TVA.HoEQWQph7f63OUHozkbG', '2cb15d57-3b30-4b06-a04d-b8d32d234e8d', '超级管理员', '超级管理员', '13888888888', 'https://img1.baidu.com/it/u=1706103831,1363884341&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500', '710957166@qq.com', 1, 1, 1, 0);
INSERT INTO `sys_user` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `login_time`, `username`, `password`, `uid`, `name`, `nick_name`, `tel`, `avatar`, `email`, `gender`, `status`, `admind`, `deleted`) VALUES (2, 'System', '2024-03-04 10:29:35', 'System', '2024-03-15 11:19:44', '2024-03-15 11:19:44', 'admin', '$2a$10$ZJrHs1/UHizEmXbw1auMs.DR9pal5TVA.HoEQWQph7f63OUHozkbG', '2cb15d57-3b30-4b06-a04d-b8d32d234e9D', '管理员', '管理员', '13888888888', 'https://img1.baidu.com/it/u=1706103831,1363884341&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500', '710957166@qq.com', 1, 1, 1, 0);
COMMIT;
