...
-- ----------------------------
-- Table structure for gpt_base_config
-- ----------------------------
DROP TABLE IF EXISTS `gpt_base_config`;
CREATE TABLE `gpt_base_config` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `create_user` varchar(32) NOT NULL DEFAULT 'System' COMMENT '创建人',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_user` varchar(32) NOT NULL DEFAULT 'System' COMMENT '更新人',
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='基础配置';

INSERT INTO `gpt_base_config` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `data`, `deleted`) VALUES (1, 'System', '2023-05-04 16:26:46', 'System', '2023-12-26 15:03:47', 'baseInfo', '{\"contentSecurity\":0,\"copyright\":\"ChatMASTER\",\"descrip\":\"ChatMASTER，支持ChatGPT、文心一言、通义千问、智谱清言等多模型\",\"keywords\":[\"ChatGPT\",\"文心一言\",\"通义千问\"],\"proxyServer\":\"\",\"siteTitle\":\"ChatMASTER\",\"domain\":\"https://chat.panday94.xyz\",\"proxyType\":1}', 0);
INSERT INTO `gpt_base_config` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `data`, `deleted`) VALUES (2, 'System', '2023-05-04 16:35:48', 'System', '2023-05-04 16:35:48', 'extraInfo', '{\"contentSecurity\":1,\"copyright\":\"ChatMASTER\",\"descrip\":\"这是我们的AI网站\",\"keywords\":[\"的\",\"测啊\"],\"proxyServer\":\"https://chat.panday94.xyz\",\"siteTitle\":\"ChatMASTER\",\"domain\":\"https://chat.panday94.xyz\",\"proxyType\":2,\"waterStatus\":0,\"filesize\":\"100\",\"filetype\":\"gif,png,jpg,jpeg,doc,docx,xls,xlsx,csv,pdf,rar,zip,txt,mp4,flv,wgt,pem\",\"waterPosition\":5,\"waterAlpha\":\"80\"}', 0);
INSERT INTO `gpt_base_config` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `data`, `deleted`) VALUES (3, 'System', '2023-05-04 16:36:37', 'System', '2023-12-26 15:06:22', 'appInfo', '{\"homeSecondTemplate\":3,\"filetype\":\"gif,png,jpg,jpeg,doc,docx,xls,xlsx,csv,pdf,rar,zip,txt,mp4,flv,wgt,pem\",\"copyright\":\"ChatMASTER\",\"descrip\":\"这是我们的AI网站\",\"keywords\":[\"的\",\"测啊\"],\"proxyServer\":\"https://chat.panday94.xyz\",\"siteTitle\":\"ChatMASTER\",\"proxyType\":2,\"filesize\":\"100\",\"h5Url\":\"https://chat.panday94.xyz/h5\",\"contentSecurity\":1,\"isSms\":1,\"homeNotice\":\"【通知】欢迎使用ChatMASTER，新用户免费获得20次对话次数，免费额度消耗完毕后可联系客服获取兑换码或分享好友获取对话次数。\",\"homeFirseTemplate\":4,\"domain\":\"https://chat.panday94.xyz\",\"homeTemplate\":1,\"waterPosition\":5,\"freeNum\":\"101\",\"isShare\":1,\"shareRewardNum\":\"10\",\"waterAlpha\":\"80\",\"waterStatus\":0}', 0);
INSERT INTO `gpt_base_config` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `name`, `data`, `deleted`) VALUES (4, 'System', '2023-05-04 16:38:58', 'System', '2023-12-26 15:07:03', 'wxInfo', '{\"filetype\":\"gif,png,jpg,jpeg,doc,docx,xls,xlsx,csv,pdf,rar,zip,txt,mp4,flv,wgt,pem\",\"copyright\":\"ChatMASTER\",\"keywords\":[\"的\",\"测啊\"],\"v3Secret\":\"\",\"siteTitle\":\"ChatMASTER\",\"mpSecret\":\"\",\"filesize\":\"100\",\"mpLogin\":1,\"contentSecurity\":1,\"homeFirseTemplate\":4,\"homeTemplate\":1,\"mpAppId\":\"\",\"waterPosition\":5,\"maSecret\":\"\",\"maPay\":1,\"waterStatus\":0,\"mchNo\":\"\",\"homeSecondTemplate\":3,\"descrip\":\"这是我们的AI网站\",\"proxyServer\":\"https://chat.panday94.xyz\",\"payCert\":\"\",\"proxyType\":2,\"h5Url\":\"chat.panday94.xyz/h5/\",\"mpPay\":1,\"isSms\":1,\"homeNotice\":\"【通知】欢迎使用ChatMASTER小程序，新用户免费获得100次对话次数，免费额度消耗完毕后可联系客服获取兑换码或分享好友获取对话次数。\",\"domain\":\"https://chat.panday94.xyz\",\"freeNum\":\"10\",\"isShare\":1,\"shareRewardNum\":\"10\",\"waterAlpha\":\"80\",\"maAppId\":\"\"}', 0);
...
CREATE TABLE `gpt_user` (
  ...
  `num` int(11) DEFAULT '20' COMMENT '调用次数',
