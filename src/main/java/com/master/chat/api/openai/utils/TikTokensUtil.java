package com.master.chat.api.openai.utils;
...
public class TikTokensUtil {
     ...
     *
     * @param modelName 模型名称
     * @param openAiMessages  消息体
     * @return tokens数量
     */
    public static int tokens(@NotNull String modelName, @NotNull List<OpenAiMessage> openAiMessages) {
