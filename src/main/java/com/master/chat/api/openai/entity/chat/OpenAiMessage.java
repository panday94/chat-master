...
import com.master.chat.api.openai.entity.chat.tool.ToolCalls;
...
@AllArgsConstructor
public class OpenAiMessage extends BaseMessage implements Serializable {
    /**
     * 旧的content属性仅仅支持字符类型
     */
     ...
     */
    public OpenAiMessage(String role, String name, String content, List<ToolCalls> toolCalls, String toolCallId, FunctionCall functionCall) {
    ...
    private OpenAiMessage(Builder builder) {
