...
import com.master.chat.api.openai.entity.chat.ChatCompletionWithPicture;
...
import com.master.chat.api.openai.entity.images.ImageResponse;
...
public interface OpenAiApi {
     ...
     * 创建助手
     *
     * @param gptAssistant 创建助手参数
     * @return 助手信息
     * @since 1.1.3
     */
    @POST("v1/assistants")
    @Headers("OpenAI-Beta: assistants=v1")
    Single<AssistantResponse> assistant(@Body GptAssistant gptAssistant);
    ...
    @Headers("OpenAI-Beta: assistants=v1")
    Single<AssistantResponse> modifyAssistant(@Path("assistant_id") String assistantId, @Body GptAssistant gptAssistant);
